...
# char_1 = pygame.image.load('ukiyoe/cha-1.png')
# over_scene = pygame.image.load("ukiyoe/game_over_1.png")
wall = pygame.image.load("Game/ground.png")
# get_ready =  pygame.image.load('ukiyoe/bg.jpg')
# game_over =  pygame.image.load('ukiyoe/bg.jpg')Ss
#monster on walk
ukiyoe_monster_1 = pygame.image.load("ukiyoe/mon-1.png")
ukiyoe_monster_2 = pygame.image.load("ukiyoe/mon-2.png")
ukiyoe_monster_3 = pygame.image.load("ukiyoe/mon-3.png")
ukiyoe_monster_4 = pygame.image.load("ukiyoe/mon-4.png")
...
# rule_pic =  pygame.image.load('ukiyoe/bg.jpg')
# pause_pic =  pygame.image.load('ukiyoe/bg.jpg')
#randomly ukiyoe-images with different effect
scene_1 = pygame.image.load("ukiyoe/bg-1.jpg")
scene_2 = pygame.image.load("ukiyoe/bg-2.jpg")
scene_3 = pygame.image.load("ukiyoe/bg-3.jpg")
...
class button():
    ...
    def draw(self,win,outline=None):
        ...
        if self.text != '':
            ...
            text = font.render(self.text, 1, (128,128,0))
...
set_same = button((255,255,255),0,420,50,50,"T")
set_different = button((255,255,255),400,420,50,50,"F")
set_right = pygame.image.load('Game/correct.jpeg')
set_wrong = pygame.image.load('Game/cross.png')
set_right = pygame.transform.scale(set_right,(100,100))
set_wrong = pygame.transform.scale(set_wrong,(100,100))
        ...
        if cd_time != 0:
            ...
            #     print(event)
                ...
                if choosing_flag == False:
                    text_2 = "Same: Left clench"
                    text_3 = "Different: Right clench"
                    text_2 = font_1.render(text_2,0,(0,0,255))
                    text_3 = font_1.render(text_3,0,(0,0,255))
                    win.blit(text_2,(0,0))
                    win.blit(text_3,(0,100))

                #character showing
                if event == "clench left" and choosing_flag == False:
                    call_flag = True
                    choosing_flag = True
                    set_same.color = (0,0,0)
                    set_different.color = (255,255,255)
                elif event == "clench right" and choosing_flag == False:
                    call_flag = False
                    choosing_flag = True
                    set_different.color = (0,0,0)
                    set_same.color = (255,255,255)
                # if choosing_flag:
                #     if call_flag:
                #         win.blit(agree_image,(0,0))
                #     else:
                #         win.blit(disagree_image,(0,0))    
                        
                if not setting_1.enemy[choice].show:
                    if choosing_flag:
                        if call_flag == sign(back_value):
                            win.blit(set_right,(200,200))
                            correct_time += 1
                        else:
                            win.blit(set_wrong,(200,200))    
                    total_time += 1
